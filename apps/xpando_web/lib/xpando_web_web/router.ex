defmodule XpandoWebWeb.Router do
  use XpandoWebWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {XpandoWebWeb.Layouts, :root}
  ...
  if Application.compile_env(:xpando_web, :dev_routes) do
