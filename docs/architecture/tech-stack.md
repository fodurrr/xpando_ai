...
|----------|------------|---------|---------|-----------|
| Frontend Language | Elixir/HEEx | 1.18.1 | LiveView templates and components | Native integration with Phoenix LiveView |
| Frontend Framework | Phoenix LiveView | 1.1+ | Real-time server-rendered UI | Eliminates API complexity, maintains real-time updates |
| UI Component Library | DaisyUI | 4.12.14 | Pre-built Tailwind components | Beautiful components with minimal configuration |
| State Management | LiveView State | Built-in | Server-side state management | Simplified state without frontend complexity |
| Backend Language | Elixir | 1.18.1 | Core application logic | Distributed computing and fault tolerance |
| Backend Framework | Phoenix + Ash | 1.8.0 / 3.5.36 | Web framework and domain layer | Comprehensive framework with built-in auth and APIs |
...
| Authentication | ash_authentication | 4.9.9 | User and node authentication | Integrated auth with policy enforcement |
...
| Bundler | ESBuild | 0.10.0 | Asset bundling | Fast JavaScript/CSS bundling |
...
| CSS Framework | Tailwind CSS | 0.2.0 | Utility-first CSS | Rapid UI development with DaisyUI |
